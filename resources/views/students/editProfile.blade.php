        ...
        <div class="col-lg-6">
            <div class="customDashboardForm">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('students.updateProfile', $studentData->id) }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_method" value="PUT">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            disabled placeholder="Name" value="{{ $studentData->firstName }}" autofocus>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                            disabled placeholder="Name" value="{{ $studentData->lastName }}">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}"
                                            name="address" id="email" value="{{ $studentData->address }}"
                                            placeholder="Email" />
                                        @if($errors->has('address'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('address') }}</strong>
        ...
        <div class="col-lg-6">
            <div class="customDashboardForm">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('students.updatePassword', $studentData->id) }}"
                            method="post">
                            @csrf
                            <input type="hidden" name="_method" value="PUT">
